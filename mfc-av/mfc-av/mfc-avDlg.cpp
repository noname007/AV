...
CmfcavDlg::CmfcavDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CmfcavDlg::IDD, pParent)
{
...
void CmfcavDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CmfcavDlg::OnQueryDragIcon()
{
